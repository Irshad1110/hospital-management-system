...
<div class="container-fluid">
  <div class="row mt-4">
       <form class="form-inline ml-5" action="searchmedicinebyid">
          ...
          <button type="submit" class="btn text-color btn-success ml-2">Search</button>
       </form>
       ...
       <a href="totalMedicines" class="ml-2"><button class="btn text-color btn-info ml-2">Total Medicines</button></a>
       <a href="expiredMedicines" class="ml-2"><button class="btn text-color btn-info ml-2">Expired Medicines</button></a> 
  </div>
  <div class="table-responsive">
          <table class="table">
  <thead class="text-color bg-info">
    <tr>
          ...
          <tbody>
            <tr class="text-center">
              ...
              <td class="mid-align"><a href="updateMedicine?medicineId=<%=m.getId()%>"><button type="button"
                  class="btn btn-success text-color">Edit Medicine</button></a>
              </td>
            </tr>
          </tbody>
    <%
