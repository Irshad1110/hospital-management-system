...
<body>
	...
	<div class="text-center">
		<h2 class="text-color">Login as your role to start using</h2>
	</div>
	<br>
    ...
    <div class="card-body">
      ...
      <p class="card-text text-center">Administrator will monitor all Users.</p>
    </div>
  </div>
    </div>
    <div class="col-sm-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text text-center">Doctor will treat patient.</p>
    </div>
  </div>
    </div>
    <div class="col-sm-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text text-center">Pharmacist will handle Medicines.</p>
    </div>
  </div>
    </div>
    <div class="col-sm-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text text-center">Receptionist will register, make bill for patient.</p>
    </div>
  </div>
    </div>
</div>  
