<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
  <a class="navbar-brand" href="/home">
   ...
   <i><b><span class="text-color">THBS Hospital</span></b></i>
  </a>
...
<div class="modal fade aboutusmodal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
       <div class="modal-header bg-info text-danger text-center">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              Hospital management system project done as a final project for the training of Torry Harris Business Solutions.
              This project can be used to get away from all the paperwork that comes with managing different departments.
      ...
      <div class="modal-footer">
       <div class="text-center">
        <button type="button" class="btn bg-info text-danger" data-dismiss="modal">Close</button>
       </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 9990197153<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">irshad@gmail.com<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">amrita@gmail.com<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">priyanka@gmail.com<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">rajini@gmail.com
            </b>
        </p>
        </div>
      </div>
