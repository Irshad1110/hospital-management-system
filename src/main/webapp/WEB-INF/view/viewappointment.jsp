       ...
       <div class="col-md-4 mx-auto" >
            ...
            <div class="row">     
             ...
             <div class="form-group">
                 ...
                 <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" cols="51" required readonly><%=appointment.getProblemdescription() %></textarea>
             </div>
             </div>
             ...
             <div class="container text-center">
                 <button class="btn btn-success text-color"><b>Update Appointment</b></button>
             </div>  
            ...
            <div class="container mx-auto">
                 ...
                 <button type="submit" class="btn text-color btn-info ml-2">Add</button>
                 <% 
            ...
            <div class="container-fluid text-center mt-2">
                     <a href="assignMedicinesToPatientDB?appointmentId=<%=appointment.getId()%>"><button class="btn btn-success text-color">Assign Medicines to Patient</button></a>
                  </div>
